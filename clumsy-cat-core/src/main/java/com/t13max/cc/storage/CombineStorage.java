 ...
 *
 * @author t13max
 * @since 11:09 2025/8/19
 */
public class CombineStorage implements IStorage {

    //缓存层
    private IStorage cacheStorage;

    //最底层
    private IStorage bottomStorage;

    public CombineStorage(IStorage cacheStorage, IStorage bottomStorage) {
        this.cacheStorage = cacheStorage;
        this.bottomStorage = bottomStorage;
    }
